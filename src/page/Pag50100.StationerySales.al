...
page 50100 "Stationery Sales"
{
    ...
    AdditionalSearchTerms = 'Sta Sales, Stationery Sales, St Sales, St Sa';
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Sell-to Customer No."; Rec."Sell-to Customer No.")
                {
                    ...
                    AboutTitle = 'Choose Customer No';
                    AboutText = 'Choose the customer who will receive the products and be billed by default.';
