...
report 50111 "Member Balance to Date"
{
    DefaultLayout = RDLC;
    RDLCLayout = './xLayout/MemberBalancetoDate.rdl';
    ...
    var
        ...
        CustBalancetoDateCaptionLbl: Label 'Member - Balance to Date';
