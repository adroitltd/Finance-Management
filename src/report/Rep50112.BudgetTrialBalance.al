...
report 50112 "Budget Trial Balance"
{
    Caption = 'Budget Trial Balance';
    DefaultLayout = RDLC;
    RDLCLayout = './xLayout/TrialBalanceBudget.rdl';
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            RequestFilterFields = "No.", "Account Type", "Account Category", "Date Filter", "Budget Filter", "Global Dimension 1 Filter", "Global Dimension 2 Filter";
            ...
            column(Budget_Balance_CaptionLbl;Budget_Balance_CaptionLbl)
            {

            }
            column(Budget_Comments_CaptionLbl;Budget_Comments_CaptionLbl)
            {
    ...
    var
        ...
        G_L_Account___Balance_at_Date_CaptionLbl: Label 'Amounts';
        G_L_Account___Balance_at_Date__Control32CaptionLbl: Label 'Credit';
        DiffAtDatePctCaptionLbl: Label 'Percentage(%)';
        GLAcc2__Budget_at_Date_CaptionLbl: Label 'Actuals';
        Budget_Balance_CaptionLbl: Label 'Balances';
        Budget_Comments_CaptionLbl: Label 'Comments';
