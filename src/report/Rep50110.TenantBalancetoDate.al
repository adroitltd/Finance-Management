...
report 50110 "Tenant Balance to Date"
{
    DefaultLayout = RDLC;
    RDLCLayout = './xLayout/TenantBalancetoDate.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'Tenant Balance to Date';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            begin
                ...
                SetRange("Date Filter", 0D, MaxDate);
                // Get report for only Tenants Customers
    ...
    var
        ...
        CustBalancetoDateCaptionLbl: Label 'Tenant - Balance to Date';
