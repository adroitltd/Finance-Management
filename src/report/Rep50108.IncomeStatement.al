...
report 50108 "Income Statement Report"
{
    // ..........INCOME STATEMENT..............//
    // ........It includes INCOME/REVENUE, EXPENSES/EXPENDITURE.....//
    Caption = 'Income Statement';
    DefaultLayout = RDLC;
    RDLCLayout = './xLayout/IncomeStatement.rdl';
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            begin
                PageGroupNo := 1;
                SetRange("Income/Balance", "G/L Account"."Income/Balance"::"Income Statement");
            end;
        }
    }
    ...
    var
        ...
        DetailedTrialBalanceReportGeneratedTxt: Label 'Income Statement report generated.', Locked = true;
