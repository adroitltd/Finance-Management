...
report 50109 "Balance Sheet Report"
{
    // ............BALANCE SHEET.................//
    // ....It includes ASSETS, LIABILITIES, EQUITY
    Caption = 'Balance Sheet';
    DefaultLayout = RDLC;
    RDLCLayout = './xLayout/BalanceSheet.rdl';
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            column(BalanceSheetCaption; BalanceSheetCaptionLbl)
            {
            }
            ...
            begin
                PageGroupNo := 1;
                SetRange("Income/Balance", "G/L Account"."Income/Balance"::"Balance Sheet");
            end;
        }
    }
    ...
    var
        ...
        BalanceSheetCaptionLbl: Label 'Balance Sheet';
        ...
        DetailedTrialBalanceReportGeneratedTxt: Label 'Balance Sheet report generated.', Locked = true;
