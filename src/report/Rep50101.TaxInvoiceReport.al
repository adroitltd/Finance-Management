report 50101 "Tax Invoice Report"
{
    ...
    DefaultRenderingLayout = "TaxInvoice.docx";
    ...
    rendering
    {
        layout("TaxInvoice.docx")
        {
            Type = Word;
            LayoutFile = './xLayout/TaxInvoice.docx';
            Caption = 'Tax Invoice (Word)';
            Summary = 'The Tax Invoice (Word) provides a simple layout that is also relatively easy for an end-user to modify.';
        }
    }
