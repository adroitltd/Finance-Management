...
report 60102 "Payment Receipt"
{
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            begin
                ...
                Check.FormatNoText(AmountInWords, Round(TotalAmount, 0.01), Header."Currency Code");
            end;
    ...
    rendering
    {
        layout("PaymentReceipt.rdl")
        {
            ...
            Summary = 'The Payment Receipt (RDLC) provides a simple layout that is also relatively easy for an end-user to modify.';
        }
    }
